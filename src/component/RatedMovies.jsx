...
const RatedMovies = () => {
  return (
   <div className='body'>
  {/*  navbar  */}
  <nav className="navbar navbar-expand-lg navok">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <a className="nav-link navmovies" aria-current="page" href="index.html">Home</a>
          </li>
          <li className="nav-item">
            <a className="nav-link navmovies" aria-current="page" href="#">Explore</a>
          </li>
          <li className="nav-item">
  ...
  <div className="container">
    ...
    <nav aria-label="breadcrumb">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active" aria-current="page">Top Rated Movies</li>
      </ol>
    </nav>
    {/* popular movies */}
    <div className="popular-movies">
      <div className="row">
        ...
        <div className="col-6 col-md-4 col-lg-2">
          <img src="img/rated19.jpg" alt />
        </div>
        <div className="col-6 col-md-4 col-lg-2">
          <img src="img/rated20.jpg" alt />
        </div>
        <div className="col-6 col-md-4 col-lg-2">
          <img src="img/rated21.jpg" alt />
        </div>
        <div className="col-6 col-md-4 col-lg-2">
          <img src="img/rated22.jpg" alt />
        </div>
      </div>
    </div>
    {/* footer */}
